...
const VALUES = [
  {
    ...
    text: "Bite-sized modules, daily habits, and real Lightyears — built the way people actually retain new skills, not just pass a one-time test.",
  },
  {
    icon: PeopleFill,
    ...
    <div className="about-page-container">
      <div className="about-content-wrapper">
        ...
        <p className="about-lede">
          ...
          module, and one Lightyears bar at a time.
        </p>
